...
public class ApiApplication {
    ...
    private static final String[] EASTER_EGGS = new String[] {
        ...
        "<iframe width=\"956\" height=\"538\" src=\"https://www.youtube.com/embed/Vhh_GeBPOhs\" title=\"Steve Ballmer: Developers\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>",
        ...
        "<html><head></head><body><style>@keyframes wobble {0% { transform: scale(0.5); }50% { transform: scale(1.2); }100% { transform: scale(0.5); }}</style><h1 style=\"text-align:center;\">LEONARDO MAGELA CUNHA</h1><img src=\"https://www.kcl.ac.uk/importedimages/schools/nms/informatics/cunhal.xccf1050d.jpg\" style=\"margin-left:auto;margin-right:auto;animation-name: wobble;animation-play-state: running;animation-duration: 0.5s;animation-iteration-count: infinite;margin-left: auto;margin-right: auto;\"></body></html>"
    };
}
